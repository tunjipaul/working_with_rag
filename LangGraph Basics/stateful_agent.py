...
🌡️ Temperature: {data['temp']}
☁️ Conditions: {data['condition']}
...
def define_word(word: str) -> str:
    ...
    """
    # Dictionary database (simulate a real dictionary)
    dictionary = {
        "ephemeral": {
...
╚════════════════════════════════════════════════════════════════════╝
    ...
    # Test 6: Tool Selection Intelligence
